...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style5">Data Integrity Audit Scheme Based on Blockchain Expansion Technology</h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2>Welcome tpa (Verifier)</h2>
            <p class="infopost">&nbsp;</p>
            <div class="style2"></div>
            <div class="img">
              <div align="justify"><img src="images/img1.jpg" width="620" height="251" alt="" class="fl" /></div>
            </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star"> tpa(Verifier) Menu</h2>
          <div class="style2"></div>
          <ul class="sb_menu">
            <li><strong><a href="D_Main.jsp">Home</a></strong></li>
            <li><strong><a href="D_ViewFiles.jsp">View File's Meta Data </a></strong></li>
