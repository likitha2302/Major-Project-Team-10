...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3">Data Integrity Audit Scheme Based on Blockchain Expansion Technology</h1>
      </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="D_Login.jsp">tpa(Verifier)</a></li>
          </ul>
        </div>
        </div>
      <div class="style2"></div>
